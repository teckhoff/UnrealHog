...
| [EP-009](EP-009-session-manager.md) | Independent rotating `$session_id` | EP-002 |
| [EP-010](EP-010-person-profile-policy.md) | Configured `$process_person_profile` behavior | EP-004, EP-007 |
...
| [EP-017](EP-017-feature-flag-called-events.md) | Deduplicated `$feature_flag_called` events | EP-003, EP-004, EP-007, external feature-flag subsystem |
