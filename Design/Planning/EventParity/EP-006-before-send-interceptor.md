...
- `Design/Reference/posthog-unity/com.posthog.unity/Runtime/PostHogConfig.cs` (`BeforeSend`)
- `Design/Reference/posthog-unity/tests/PostHog.Unity.Tests/PostHogSDKTests.cs` (`TheBeforeSendCallback`)
