...
* Require correctly typed `uuid`, `event`, `distinct\_id`, `timestamp`, and `properties` fields.
...
* `Design/Reference/posthog-unity/com.posthog.unity/Runtime/Core/EventQueue.cs` (`LoadEvents`, `DeserializeEvent`)
